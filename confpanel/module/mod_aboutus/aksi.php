                  ...
                  <hr>
                    <form class=\"form-horizontal style-form\" action=\"../../module/mod_aboutus/aksi.php?tentangkami=add\" method=\"POST\" enctype=\"multipart/form-data\">
                      <div class=\"form-group\">          
                          ...
                          <div class=\"col-sm-10\"> 
                          <input type=\"file\" class=\"\" name=\"pict_aboutus\"><p></p>
                          </div>
                  ...
                  <hr>
                    <form class=\"form-horizontal style-form\" action=\"../../module/mod_aboutus/aksi.php?tentangkami=update&id_aboutus=$showaboutus[id_aboutus]\" method=\"POST\" enctype=\"multipart/form-data\">
                      <div class=\"form-group\">          
                          ...
                          <label class=\"col-sm-2 col-sm-2 control-label\">Informasi</label>
                          <div class=\"col-sm-10\">
                              <input type=\"text\" class=\"form-control\" name=\"description_aboutus\" value=\"$showaboutus[description_aboutus]\" oninvalid=\"alert('Informasi harus di isi !');\">
                          </div>
                          ...
                          <input type=\"file\" accept=\"image/*\" onchange=\"preview_image(this,'preview')\" class=\"\" name=\"pict_aboutus\" value=\"$showaboutus[pict_aboutus]\" oninvalid=\"alert('Gambar belum di upload !');\">
                          </div>
