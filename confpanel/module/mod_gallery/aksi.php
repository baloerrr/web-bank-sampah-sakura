                  ...
                  <hr>
                    <form class=\"form-horizontal style-form\" action=\"../../module/mod_gallery/aksi.php?galeri=add\" method=\"POST\" enctype=\"multipart/form-data\">
                      <div class=\"form-group\">          
                          ...
                          <div class=\"col-sm-10\"> 
                          <input type=\"file\" class=\"\" name=\"pict_gallery\" oninvalid=\"alert('Gambar belum di Upload !');\"><p></p>
                          </div>
                          <label class=\"col-sm-2 col-sm-2 control-label\">Kategori Gambar</label>
                          <div class=\"col-sm-10\">
                              <input type=\"text\" class=\"form-control\" name=\"category_gallery\" oninvalid=\"alert('Kategori gambar harus di isi !');\">
                          </div>
                      </div>
                </table>      
                  <hr>
