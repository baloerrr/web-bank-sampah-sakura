...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <p class="language" hidden><?=language?> : <a href="index.php?lang=in" hidden> Indonesia</a> | <a
                            href="index.php?lang=en" hidden> English</a></p>
    ...
    <div class="parallax-content baner-content" id="home">
        <div class="container overflow-hidden pt-0">
            <div class=" row justify-content-xl-evenly justify-content-md-evenly pe-5">
                <div class="col-md-4 col-lg-6 col-xl-6 ">
                    <?php
                     foreach ($mysqli->get_show_profile() as $showprofile) {

                         echo "<h1 class=\"fw-bold mt-5\">$showprofile[titleparagraf]</h1>
                         <p class='pt-3'>$showprofile[welcomeparagraf]</p>";
                     }
                    ?>
                    <div class="primary-white-button">
                        <a
                            href="https://drive.google.com/file/d/1Yfwm8r_p3UXjFpLRfLUYpP8cP9CltviZ/view?usp=drivesdk"><?=moredetail?></a>
                    </div>
                </div>
                <div class="img-container col-md-4 col-lg-6 col-xl-6">
                    <img class="img-jumbotron pe-5 pe-xl-5" src="./img/trash3.png" width="600" walt="">
                </div>
            </div>
        </div>
        <!-- <div class="container">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="pop">
                        ...
                        <form id="contact" action="index.php" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="date_receive_inbox" id="date"
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <input name="email" type="email" class="form-control" id="email"
                                            placeholder="<?=placeemail?>" required="">
                                    </fieldset>
                                </div>
                                <div class="col-md-12">
                                    <fieldset>
                                        <input name="subject" type="text" class="form-control" id="subject"
                                            placeholder="<?=placesubject?>" required="">
                                    </fieldset>
                                </div>
                                <div class="col-md-12">
                                    <fieldset>
                                        <textarea name="message" rows="6" class="form-control" id="message"
                                            placeholder="<?=placemessage?>" required=""></textarea>
                                    </fieldset>
                                </div>
                                <div class="col-md-12">
                                    <fieldset>
                                        <button type="submit" name="submitemail" id="form-submit"
                                            class="btn"><?=buttonsendmail?></button>
                                    </fieldset>
                                </div>
                            </div>
                        </form>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="logo">
                        ...
                        <p>Copyright &copy; <?php echo date("Y"); ?>
                            | <strong>Bank Sampah Sakura</strong> </p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="location">
